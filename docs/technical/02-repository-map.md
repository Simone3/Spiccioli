...
| `ipc/ImportIpc.ts` | The one channel a bank export crosses ([§5.7](../functional/specs/05-transactions.md#57-bulk-import)): the chooser, the bytes, and a grid of cell text back. **The path never crosses**, and nothing but a path, a count and a reason reaches the log |
