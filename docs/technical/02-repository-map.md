...
| `components/portfolio/` | The one folder that still holds a shell and an empty state, until the phase that builds it |
...
| `logic/checks/CheckDates.ts` | The day arithmetic the windows and the ages are written in |
